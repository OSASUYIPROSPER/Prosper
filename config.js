...
ALIVE_MSG: process.env.ALIVE_MSG || "HEY DEAR, I'm thrilled to announce that prosper is ALIVE now—ready to dive into new adventures with you!",
SUDO_NB: process.env.SUDO_NB || "2349116370966",
